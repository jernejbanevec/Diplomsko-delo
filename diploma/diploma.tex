...
%\end{bmatrix} 
%,$$
%\textbf{-- Kako lahko tu naredim, da dobimo v levem delu matrike ničle (v primeru $n < k$)? - Bi morda moral pred razcepom urediti na primeren način? Lahko bi npr. poračunal "stolpično kanonično formo", tako da imam na najbolj levi strani ničelne stolpce. Ali je morda to mišljeno le da te odvečne vrstice preslika v 0?} 
...
0_{n-k+r, r} & & \\ 
 ...
 & & I_{k-r-s}
\end{bmatrix}
$, matriki $D_A$ in $D_B$ sta pa oblike
$
D_A =
\begin{bmatrix}
\alpha_{r+1} & & \\
