...
z izbiro optimalne preslikave $G$, kjer sta matriki $S_1$ in $S_2$ izbrani izmed matrik $S_W$, $S_B$ in $S_M$. Ker je tu matrika $S_2$ nesingularna in je sestavljena kot produkt matrike in transponiranke te matrike je simetrično pozitivno definitna (posldično so vse lastne vrednosti te matrike večje ali enake 0). Za simetrično poitivno definitno matriko pa obstaja razcep Choleskega; tako vemo da obstaja spodnjetrikotna matrike V s pozitivnimi elementi na diagonali, da velja:
$$ S_2 = V V^T \text{.}
$$
