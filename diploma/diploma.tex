...
$$
Tako iz zgornje enačbe \eqref{eq:1} dobimo:
$$
\begin{pmatrix}
A Z_{11} & A Z_{12} \\ 
B Z_{11} & B Z_{12}
...
Sedaj singularni razcep naredimo na matriki $B_1$. Za matriko $B_1$ vemo, da ima isti rang kot matrika $B$, saj vemo, da je matrika $Z_{11}$ polnega ranga (je namreč podmatrika ortogonalne matrike $Z$) in vemo, da je matrika $D^{-1}$ polnega ranga. Označimo: $r = rang(B) = rang(B_1)$. Iz singularnega razcepa za matriko $B_1$ dobimo ortogonalni matriki $V$ in $Z_2$, da velja:
$V^T B_q Z_2 = diag(\beta_1, \ldots, \beta_p)$, kjer je $p = min{}$
